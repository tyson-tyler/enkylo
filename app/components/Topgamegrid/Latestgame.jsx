...
export default function LatestGame() {
  return (
    <section className="bg-black pb-52 px-[20px] md:px-[70px]">
      ...
      {/* Grid Layout - Hidden on small screens */}
      <div className=" lg:grid  h-auto  grid-cols-1 md:grid-cols-2 md:grid-rows-3 gap-8">
        <div className="h-[400px] md:h-[860px] gap-9 border mb-5 md:mb-7   md:row-span-2">
          <BentoCard
        ...
        <div className="h-[400px] mt-5 md:mt-0 ">
          <BentoCard
        ...
        <div className="h-[400px] mt-5 lg:mt-0">
          <BentoCard
